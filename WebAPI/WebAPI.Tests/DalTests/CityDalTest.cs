...
namespace WebAPI.Tests.DalTests
{
    ...
    public class CityDalTest: IClassFixture<BaseTestFixture>, IDisposable
    {
        #region Declarations
        ...
        public CityDalTest(BaseTestFixture fixture)
        {
        ...
        public void GetCityById_ExistingId_ShouldReturnValue(int cityId)
        {
            using (var scope = _iContainer.BeginLifetimeScope(AppContextType.UnitTest.ToString()))
            {
                ...
                var cityResult = _iCityDal.GetCityById(cityId);
        ...
        public void SaveCity_SaveNewCity_ShouldSaveSuccessfully(int countryId, string Name)
        {
            using (var scope = _iContainer.BeginLifetimeScope(AppContextType.UnitTest.ToString()))
            {
                ...
                var cityResult = _iCityDal.SaveCity(city);
